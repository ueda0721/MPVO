#ifndef MPVO_LOCAL_PLANNER_MPVO_PLANNER_H_
#define MPVO_LOCAL_PLANNER_MPVO_PLANNER_H_
...
namespace mpvo_local_planner {
  ...
  class MPVOPlanner {
    public:
       ...
       */
      MPVOPlanner(std::string name, base_local_planner::LocalPlannerUtil *planner_util);

      /**
       * @brief Reconfigures the trajectory planner
       */
      void reconfigure(MPVOPlannerConfig &cfg);
    ...
    private:
      ...
      double sim_period_;///< @brief The number of seconds to use to compute max/min vels for mpvo
